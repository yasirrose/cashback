...
import {
  BFormInput, BFormGroup, BForm, BRow, BCol, BButton, BFormSelect, BFormCheckbox,BFormTextarea,
} from 'bootstrap-vue'
import {
...
export default {
  ...
  data() {
    return {
      ...
      validationErrors: "",
      info: "",
      cashbackId:this.$route.params.id
    }
  },
    created() {
    this.getCashback();
  ...
  methods: {
    getUsers() {
      ...
      AdminApi.getRow(
          ...
          this.cashbackId,
        data => {
             console.log('get cashback response is', data.data);
             const resp = data.data;
             this.userId = resp.user_id;
             this.amount = resp.amount;
             this.affiliateUrl = resp.affiliate_url;
